...
# -------------------------
# 5. DOCKER GRUBU VE SOCKET YETKİSİ (OTOMATİK)
# -------------------------
if ! groups $USER | grep -q "\bdocker\b"; then
    echo "⚡ Kullanıcı docker grubuna ekleniyor..."
    sudo usermod -aG docker $USER
    echo "⚡ Docker socket yetkisi geçici olarak ayarlanıyor..."
