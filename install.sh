...
echo "-------------------------------------------------------------------"
echo "🖨️  Architecture: aarch64 (ARM64) optimized."
...
echo "📦 Updating system and installing printer drivers..."
...
<a id="link-jellyfin" href="#" class="card"><span class="icon">🍿</span><div class="title">Jellyfin</div><div class="desc">Stream Media</div></a>
...
<a id="link-cups" href="#" class="card"><span class="icon">🖨️</span><div class="title">Printer</div><div class="desc">CUPS (Native)</div></a>
</div>
<script>
